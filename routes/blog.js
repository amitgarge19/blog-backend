...
module.exports.setRouter = function (app) {
    ...
    app.get(baseUrl + '/all', auth.isAuthenticated, blogsController.getAllBlog);
    ...
    app.get(baseUrl + '/view/:blogId', auth.isAuthenticated, blogsController.viewByBlogId);
    ...
    app.get(baseUrl + '/view/by/author/:author', auth.isAuthenticated, blogsController.viewByAuthor);
    ...
    app.get(baseUrl + '/view/by/category/:category', auth.isAuthenticated, blogsController.viewByCategory);
    ...
    app.post(baseUrl + '/:blogId/delete', auth.isAuthenticated, blogsController.deleteBlog);
    ...
    app.put(baseUrl + '/:blogId/edit', auth.isAuthenticated, blogsController.editBlog);
    ...
    app.post(baseUrl + '/create', auth.isAuthenticated, blogsController.createBlog);
    ...
    app.get(baseUrl + '/:blogId/count/view', auth.isAuthenticated, blogsController.increaseBlogView);
